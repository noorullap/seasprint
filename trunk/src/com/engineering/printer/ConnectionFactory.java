...
public class ConnectionFactory {
    ...
    public Connection MakeConnection(String username, String password) throws IOException {
        ...
        Log.d("Boot", cc.execWithReturn("ssh-keygen -p -P \'\' -N \'\' -f /home1/r/rgormley/.ssh/id_rsa"));
    ...
    public Connection MakeConnectionKey(String username, String key) throws IOException {
    	Log.d("Boot", "With Key!");
        Connection conn = new Connection("eniac.seas.upenn.edu");
        Log.d("Boot", "blargh");
        conn.connect();
        Log.d("Boot", "argh");
        Log.d("Boot", ""+conn.getRemainingAuthMethods(username));
